...
#Add an internal dataset that users can load in data/ folder.
...
# Add overwrite = TRUE, to update dataset if you ever make any changes
# rda created users can load as we load in pacages data(my_dataset)
usethis::use_data()
